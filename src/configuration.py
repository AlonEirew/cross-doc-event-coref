...
class Configuration(object):
    ...
    def init_inference(self):
        ...
        self.event_test_file_pos = str(LIBRARY_ROOT) + "/resources/" + \
                            ...
                            "/Event_gold_mentions_PosPairs.pickle"
