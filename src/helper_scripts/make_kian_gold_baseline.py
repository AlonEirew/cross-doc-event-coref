...
def main():
    corpus_id = 'wec'
    dev_in_file = str(LIBRARY_ROOT) + '/resources/dataset_full/WEC_Dev_Full_Event_gold_mentions_validated.json'
    dev_out_file = str(LIBRARY_ROOT) + '/resources/gold_scorer/' + corpus_id + '/CD_dev_event_mention_based.txt'

    test_in_file = str(LIBRARY_ROOT) + '/resources/dataset_full/WEC_Test_Full_Event_gold_mentions_validated.json'
    test_out_file = str(LIBRARY_ROOT) + '/resources/gold_scorer/' + corpus_id + '/CD_test_event_mention_based.txt'
