...
def load_modules(cdc_resources):
    ...
    models.append(VerboceanRelationExtraction(cdc_resources.vo_search_method,
                                              cdc_resources.vo_dict_file))
